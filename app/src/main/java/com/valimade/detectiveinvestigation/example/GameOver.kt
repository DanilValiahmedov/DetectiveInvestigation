...
object GameOver {
    ...
    val dossiers = listOf(
        Dossier(
            ...
            title = "Александр Сергеевич Воронцов",
            age = "34 года",
        ...
        Dossier(
            ...
            title = "Игорь Иванович Мельников",
            age = "41 год",
            post = "Руководитель отдела разработки",
            description = "Руководил производством проекта последние два года. По словам сотрудников, требовал соблюдения жестких сроков разработки и регулярно вводил переработки перед релизом. По словам коллег часто конфликтовал с Александром, потому что игра не успевала сдаться в срок.",
            alibi = "Во время гибели находился на совещании с инвесторами.",
        ),
        Dossier(
            id = UUID.fromString("f8d467fa-295c-4c43-9027-b9d9b4b44521"),
            title = "Кирилл Жданов Михайлович",
            age = "25 лет",
            post = "Младший разработчик",
            description = "Работал в команде погибшего менее года. Участвовал в разработке уровня «Битва за Порт-Артур». По информации сотрудников, опасался попасть под сокращение после провала проекта.",
        ...
        Dossier(
            ...
            title = "Олег Савельев",
            age = "39 лет",
            post = "Начальник службы безопасности",
            description = "Отвечает за внутреннюю безопасность компании и контроль утечек информации. Ранее проходил военную службу. По словам коллег, отличается жестким стилем общения и подозрительным отношением к сотрудникам. В последнее время многие вдели, что он часто приходил к Александру в кабинет.",
    ...
    val action = listOf(
        Action(
            ...
            title = "Изучить досье коллег погибшего",
            description = "Перед началом расследования необходимо ознакомиться с личными делами сотрудников, которые контактировали с погибшим в последние дни перед смертью.",
            isShow = true,
            relatedDossier = listOf(
                UUID.fromString("bda9c768-a691-4c78-b5d0-f14c82af2b94"),
                UUID.fromString("f8d467fa-295c-4c43-9027-b9d9b4b44521"),
                UUID.fromString("ec13e49f-c0cf-4249-956f-a851aaabf47d"),
            )
        ),
        Action(
            id = UUID.randomUUID(),
            type = ActionType.INTERROGATE,
            title = "Допросить руководителя отдела разработки",
            description = "Руководитель отдела одним из последних общался с погибшим перед его смертью. Необходимо выяснить, в каком состоянии находился разработчик после провального релиза и были ли между ними конфликты.",
            relatedDossier = listOf()
        ),
        Action(
            id = UUID.randomUUID(),
            type = ActionType.INTERROGATE,
            title = "Допросить младшего разработчика",
            description = "Младший разработчик работал вместе с погибшим над спорным уровнем «Битва за Порт-Артур». Необходимо проверить, как складывались их отношения внутри команды.",
            relatedDossier = listOf()
        ),
        Action(
            id = UUID.randomUUID(),
            type = ActionType.INTERROGATE,
            title = "Допросить сотрудника службы безопасности",
            description = "Служба безопасности компании отвечает за внутренний контроль офиса и доступ сотрудников к закрытой информации. Необходимо установить, замечал ли он что-либо подозрительное перед смертью разработчика.",
            relatedDossier = listOf()
        )
    )
